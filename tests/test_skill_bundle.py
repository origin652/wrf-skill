...
class SkillBundleTests(unittest.TestCase):
    def create_source_tree(self, root: Path) -> None:
        ...
        (root / "config" / "post_schema.json").write_text("{}\n", encoding="utf-8")
    ...
    def test_manifest_includes_only_whitelisted_files(self) -> None:
        ...
        self.assertIn("config/post_schema.json", files)
    ...
    def test_stage_and_install_bundle(self) -> None:
        ...
        self.assertTrue((target_root / "config" / "post_schema.json").exists())
    ...
    def test_create_bundle_archive_writes_tarball(self) -> None:
        ...
        self.assertIn("wrf-skill-bundle/config/post_schema.json", names)
