...
2. Prefer repo-root `scripts/wrf.py post` for project-level post-processing; keep `scripts/post_spec.py`, `scripts/wrf_post.py`, and `scripts/plot_wrfout.py` for spec work and low-level rendering.
